...
const Schools               = require('../managers/entities/schools/Schools.manager');
const Classrooms            = require('../managers/entities/classes/Classes.manager');
const Students            = require('../managers/entities/students/Students.manager');
...
module.exports = class ManagersLoader {
    ...
    load() {
        ...
        this.managers.schools             = new Schools(this.injectable);
        this.managers.classrooms          = new Classrooms(this.injectable);
        this.managers.students            = new Students(this.injectable);
        /*************************************************************************************************/
