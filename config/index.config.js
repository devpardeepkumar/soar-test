...
const MONGO_URI                        = "mongodb+srv://devpardeepkumar60:aCKOrqZKqpxhFLX3@cluster0.5apyl.mongodb.net/soar";//process.env.MONGO_URI || `mongodb://localhost:27017/${SERVICE_NAME}`;
